...
| `evolvesFrom`, `evoFrom*`                                              | Evolution relationships and conditions. Evolution must actually be supported in the destination game; an evolution link alone does not prove native acquisition there.                         |
